    ...
    <div class="container">
        ...
        <div class="carousel-gallery">
            ...
            <div class="carousel-item">
                <div class="carousel-container">
                    <div class="carousel-slide active">
                        <img src="{{ asset('images/humas/rifa_1.png') }}" alt="Humas Foto 1">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/humas/rifa_2.png') }}" alt="Humas Foto 2">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/humas/rifa_3.png') }}" alt="Humas Foto 3">
                    </div>
                </div>
                <div class="carousel-info">
                    <p class="carousel-name">Rifa</p>
                    <p class="carousel-faculty">FEB - 24</p>
                </div>
            </div>
            ...
            <div class="carousel-item">
                <div class="carousel-container">
                    <div class="carousel-slide active">
                        <img src="{{ asset('images/humas/fatina_1.png') }}" alt="Bendahara Foto 1">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/humas/fatina_2.png') }}" alt="Bendahara Foto 2">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/humas/fatina_3.png') }}" alt="Bendahara Foto 3">
                    </div>
                </div>
                <div class="carousel-info">
                    <p class="carousel-name">Fatina</p>
                    <p class="carousel-faculty">FEB - 24</p>
                </div>
            </div>
        </div>
