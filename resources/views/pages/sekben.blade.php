    ...
    <div class="container">
        ...
        <div class="carousel-gallery">
            ...
            <div class="carousel-item">
                <div class="carousel-container">
                    <div class="carousel-slide active">
                        <img src="{{ asset('images/sekben/sekretaris_1.png') }}" alt="Sekretaris Foto 1">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/sekben/sekretaris_2.png') }}" alt="Sekretaris Foto 2">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/sekben/sekretaris_3.png') }}" alt="Sekretaris Foto 3">
                    </div>
                </div>
                <div class="carousel-info">
                    <p class="carousel-name">Sekretaris</p>
                    <p class="carousel-faculty">Nama - Fakultas 24</p>
                </div>
            </div>
            ...
            <div class="carousel-item">
                <div class="carousel-container">
                    <div class="carousel-slide active">
                        <img src="{{ asset('images/sekben/bendahara_1.png') }}" alt="Bendahara Foto 1">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/sekben/bendahara_2.png') }}" alt="Bendahara Foto 2">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/sekben/bendahara_3.png') }}" alt="Bendahara Foto 3">
                    </div>
                </div>
                <div class="carousel-info">
                    <p class="carousel-name">Bendahara</p>
                    <p class="carousel-faculty">Nama - Fakultas 24</p>
                </div>
            </div>
        </div>
