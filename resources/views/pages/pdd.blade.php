    ...
    <div class="container">
        ...
        <div class="carousel-gallery">
            <div class="carousel-item">
                <div class="carousel-container">
                    <div class="carousel-slide active">
                        <img src="{{ asset('images/pdd/arleta_1.png') }}" alt="PDD Foto 1">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/pdd/arleta_2.png') }}" alt="PDD Foto 2">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/pdd/arleta_3.png') }}" alt="PDD Foto 3">
                    </div>
                </div>
                <div class="carousel-info">
                    <p class="carousel-name">Arleta</p>
                    <p class="carousel-faculty">FSTEM - 24</p>
                </div>
            </div>
            ...
            <div class="carousel-item">
                <div class="carousel-container">
                    <div class="carousel-slide active">
                        <img src="{{ asset('images/pdd/herdian_1.png') }}" alt="PDD Foto 4">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/pdd/herdian_2.png') }}" alt="PDD Foto 5">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/pdd/herdian_3.png') }}" alt="PDD Foto 6">
                    </div>
                </div>
                <div class="carousel-info">
                    <p class="carousel-name">Herdian</p>
            ...
            <div class="carousel-item">
                <div class="carousel-container">
                    <div class="carousel-slide active">
                        <img src="{{ asset('images/pdd/karina_1.png') }}" alt="PDD Foto 7">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/pdd/karina_2.png') }}" alt="PDD Foto 8">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/pdd/karina_3.png') }}" alt="PDD Foto 9">
                    </div>
                </div>
                <div class="carousel-info">
                    <p class="carousel-name">Karina</p>
                    <p class="carousel-faculty">FV - 24</p>
                </div>
            </div>
