    ...
    <div class="container">
        ...
        <div class="carousel-gallery">
            <div class="carousel-item">
                <div class="carousel-container">
                    <div class="carousel-slide active">
                        <img src="{{ asset('images/acara/acara_1.png') }}" alt="Acara Foto 1">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/acara/acara_2.png') }}" alt="Acara Foto 2">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/acara/acara_3.png') }}" alt="Acara Foto 3">
                    </div>
                </div>
                <div class="carousel-info">
                    <p class="carousel-name">Rachmah</p>
                    <p class="carousel-faculty">FT - 24</p>
                </div>
            </div>
            ...
            <div class="carousel-item">
                <div class="carousel-container">
                    <div class="carousel-slide active">
                        <img src="{{ asset('images/acara/acara_4.png') }}" alt="Acara Foto 4">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/acara/acara_5.png') }}" alt="Acara Foto 5">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/acara/acara_6.png') }}" alt="Acara Foto 6">
                    </div>
                </div>
                <div class="carousel-info">
                    <p class="carousel-name">Ayu</p>
                    <p class="carousel-faculty">FBIPK - 24</p>
                </div>
            </div>
            ...
            <div class="carousel-item">
                <div class="carousel-container">
                    <div class="carousel-slide active">
                        <img src="{{ asset('images/acara/acara_7.png') }}" alt="Acara Foto 7">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/acara/acara_8.png') }}" alt="Acara Foto 8">
                    </div>
                    <div class="carousel-slide">
                        <img src="{{ asset('images/acara/acara_9.png') }}" alt="Acara Foto 9">
                    </div>
                </div>
                <div class="carousel-info">
                    <p class="carousel-name">Adinda</p>
                    <p class="carousel-faculty">FIB - 24</p>
                </div>
            </div>
