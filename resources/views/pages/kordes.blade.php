...
<body>
    ...
    <div class="container">
        <div class="page-header">
            <h1>Koordinator Desa </h1>
        </div>

        <div class="carousel-container">
            <div class="carousel-slide active">
                <img src="{{ asset('images/kordes/kordes_1.png') }}" alt="Kordes Foto 1">
            </div>
            <div class="carousel-slide">
                <img src="{{ asset('images/kordes/kordes_2.png') }}" alt="Kordes Foto 2">
            </div>
            <div class="carousel-slide">
                <img src="{{ asset('images/kordes/kordes_3.png') }}" alt="Kordes Foto 3">
            </div>
            <div class="carousel-counter">
                <span id="current-slide">1</span> / 3
            </div>
        </div>

        <div class="carousel-info">
            <p class="carousel-name">Rasyid</p>
            <p class="carousel-faculty">Fisip - 24</p>
        </div>
    </div>
